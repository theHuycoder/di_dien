      ...
      <div className="flex items-start justify-between container mx-auto relative">
        ...
        <div className="flex flex-col items-end">
          ...
          <p className="w-[493px] text-base font-medium leading-6 text-justify mb-[142px]">
            ...
            gỡ giữa nghệ thuật và công nghệ, Dị Diện hướng đến việc diễn giải sự
            hiện diện rộng rãi của công nghệ mới đang tác động đến mối quan hệ
            giữa người và người với thế giới xung quanh.
          </p>
          {/*<div>*/}
