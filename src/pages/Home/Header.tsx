...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="container mx-auto embla w-full mt-8 absolute top-0 left-0 right-0">
          ...
          >
            {carouselItems.map((item) => {
              return (
                ...
                >
                  <img
                    className="absolute w-3/5 max-h-1/4 top-[18%] left-[50%] right-0 z-10 -translate-x-1/2"
                    src={item.img}
                    alt={item.title}
                  />
                  <img
                    className="absolute w-3/5  max-h-1/2  top-[18%] left-[50%] right-0 z-0 -translate-x-1/2"
                    src={item.bgImg}
                    alt=""
                  />
                </div>
      ...
      <div className="flex items-start justify-between container mx-auto relative z-20">
        ...
        <div className="flex flex-col gap-[88px]">
          {carouselItems.map((item, idx) => {
            ...
            return (
              ...
              >
                <p
                  className={`text-[${isActive ? "40px" : "24px"}] text-${
