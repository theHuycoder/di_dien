...
import Bo from "/home/bo.jpg";
import Human from "/home/human.jpg";
...
const Arts = () => {
  ...
  const onScroll = () => {
    ...
    const isGalleryRefInViewport =
      galleryRef.current.getBoundingClientRect().top < window.innerHeight;
  ...
  return (
    <div ref={component}>
      ...
      <div
        ref={galleryRef}
        className="container mx-auto text-center mt-[100px] mb-[300px]"
      >
      ...
      <div>
        <div className="embla mx-auto w-[1640px]">
          <div className="embla__viewport">
            <div
              ref={slider}
              className="embla__container flex items-center gap-[62px]"
            >
